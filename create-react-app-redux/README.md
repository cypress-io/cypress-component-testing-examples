...
1. Initialize a baseline project in the [create-react-app-redux](.) subdirectory
   ...
   3. Commit [`f563814`](https://github.com/cypress-io/cypress-component-testing-examples/commit/f563814dbbcc20d7065eef1b038f810a7cb7e4ac)
2. Update the app Redux store to be more easily testable
   1. Update [src/app/store.js](src/app/store.js)
   2. Commit [`e77563b`](https://github.com/cypress-io/cypress-component-testing-examples/commit/e77563b77ba793b572b813baf469f197dedcbce8)
3. Add Cypress component testing support with a sample test
   ...
   8. Commit [`547a222`](https://github.com/cypress-io/cypress-component-testing-examples/commit/547a22245a447a32290ed05df805ccbfc047b9e2)

_This example was generated by [create-react-app-redux.sh](https://github.com/cypress-io/cypress-component-testing-examples/blob/main/scripts/create-react-app-redux.sh) on 2021-05-26. The original README follows._
